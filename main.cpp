...
struct GpuPathTracerApp : Granite::Application, Granite::EventHandler {
  GpuPathTracerApp()
  {
    EVENT_MANAGER_REGISTER_LATCH(
      GpuPathTracerApp, onSwapchainCreated, onSwapchainDestroyed, SwapchainParameterEvent);
  }

  void onSwapchainCreated(const SwapchainParameterEvent &e)
  {
    graph.reset();
  ...
  void onSwapchainDestroyed(const SwapchainParameterEvent &) {}
